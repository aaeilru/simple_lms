...
class Course(models.Model):
    ...
    class Meta:
        ...
        indexes = [
            # Index untuk filter/sort berdasarkan harga (dipakai di dashboard)
            models.Index(fields=['price'], name='idx_course_price'),
            # Index komposit untuk query "tampilkan course milik teacher, urut harga"
            models.Index(fields=['teacher', 'price'], name='idx_course_teacher_price'),
            # Index untuk filter terbaru (created_at sering dipakai order_by)
...
class CourseMember(models.Model):
    ...
    class Meta:
        ...
        indexes = [
            # Sering dipakai: "semua member dari course X"
            models.Index(fields=['course_id'], name='idx_coursemember_course'),
            # Sering dipakai: "semua course yang diikuti user Y"
...
class CourseContent(models.Model):
    ...
    class Meta:
        ...
        indexes = [
            # Sering dipakai: "semua konten dari course X"
...
class Comment(models.Model):
    ...
    class Meta:
        ...
        indexes = [
            # Sering dipakai: "semua komentar pada konten X"
